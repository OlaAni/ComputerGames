...
-- Dumping data for table comp_games.product: ~21 rows (approximately)
...
INSERT INTO `user` (`idUser`, `name`, `email`, `password`, `age`, `favgenre`, `tradeamo`, `employee`, `location`) VALUES
                                                                                                                      ...
                                                                                                                      (113, 'eric', 'eric@gmAIL.COM', 'PASS', 0, 'Blank', 0, 'false', 'ucc'),
                                                                                                                      (115, 'Matt', 'matt@gmail.com', 'pass', 0, 'Blank', 0, 'false', 'ucc');

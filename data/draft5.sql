...
-- Dumping data for table comp_games.product: ~20 rows (approximately)
DELETE FROM `product`;
...
INSERT INTO `product` (`idProduct`, `name`, `price`, `genre`, `part`, `image`, `description`, `rarity`, `type`) VALUES
	...
	(4, 'CrossingAnimals', 30, 'StoryTelling', '0', 'CrossingAnimals.png', 'StoryTelling game', 'BLANK', 1),
	(5, 'RTX 3090', 1000, '0', 'GPU', 'RTX3090.png', 'RTX3090', 'VERY', 0),
	(6, 'Intel 5', 25, '0', 'CPU', 'Intel5.png', 'Intel 5', 'COMMON', 0),
	(7, 'Elden Square', 60, 'Horror', '0', 'placeholder.png', 'BLANK', 'SUPER', 1),
	(8, 'Light Souls', 30, 'Horror', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(9, 'Shadow of Peace', 15, 'Adventure', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(10, 'Marvel SuperHeroes 2', 25, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(11, 'CloseLaugh 3', 35, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(12, 'CenterSea 2', 34, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(13, 'Dragon Age Indifference', 34, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(14, 'Devils Line', 45, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(15, 'Liberty', 23, '0', '0', 'placeholder.png', 'BLANK', 'BLANK', 1),
	(16, 'SSD', 25, '0', 'Storage', 'placeholder.png', 'BLANK', 'BLANK', 0),
	(17, 'SSD', 25, '0', 'Storage', 'placeholder.png', 'BLANK', 'BLANK', 0),
	(18, 'SSD', 25, '0', 'Storage', 'placeholder.png', 'BLANK', 'BLANK', 0),
	(19, 'SSD', 25, '0', 'Storage', 'placeholder.png', 'BLANK', 'BLANK', 0),
	(20, 'SSD', 25, '0', 'Storage', 'placeholder.png', 'BLANK', 'BLANK', 0);
...
-- Dumping data for table comp_games.trade: ~7 rows (approximately)
DELETE FROM `trade`;

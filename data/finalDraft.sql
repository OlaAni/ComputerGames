...
-- Dumping data for table comp_games.product: ~18 rows (approximately)
DELETE FROM `product`;
...
INSERT INTO `sale` (`idSale`, `fullPrice`, `date`, `Customer_idCustomer`, `Product_idProduct`, `amount`, `uniqueSaleId`) VALUES
	(2, 117.5, NULL, 101, 2, NULL, NULL),
	(48, 47, '2022-04-07 12:44:21', 101, 1, 1, NULL),
	(49, 47, '2022-04-07 12:44:21', 101, 6, 2, NULL);
